...
var server = http.createServer(function (request, response){
    ...
    else if (request.url === "/newCars.html") {
    ...
    else if (request.url === "/images/ocelot1.jpg") {
         fs.readFile('./images/ocelot1.jpg', function (errors, contents){
             response.writeHead(200, {'Content-type': 'image/jpg'});
             response.write(contents); 
             response.end();
         });
    }
    else if (request.url === "/images/ocelot2.png") {
         fs.readFile('./images/ocelot2.png', function (errors, contents){
